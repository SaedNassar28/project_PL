 ...
 * @author besho
 */
public class Professor_UpdatePanel extends javax.swing.JPanel {

    /**
     * Creates new form Professor_UpdatePanel
     */
    public Professor_UpdatePanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelSucessOrFail.setText("Write professor ID to get all info ...!       before Update or Delete....!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
          if (!jTextFieldSearchKey.getText().equals("")) {
            Professor x = new Professor();
            if (x.deleteProfessor(Integer.parseInt(jTextFieldSearchKey.getText()))) {
   ...
   protected void setPanelData(Professor x) {
        ...
        jTextField1.setText(""+ x.getOfficeHours());
